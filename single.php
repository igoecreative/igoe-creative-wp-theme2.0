			...
			<div class="row">
				...
				<?php if (have_posts()): while (have_posts()) : the_post(); ?>
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<span class="date"><?php the_time('F j, Y'); ?> <?php the_time('g:i a'); ?></span> – <span class="author"><?php _e( 'Published by', 'igoecreative' ); ?> <?php the_author_posts_link(); ?></span>

						<?php the_content();?>

						<p><?php the_tags( __('Tags: ', 'igoecreative' ), ', ', '<br>');?></p>
						<p><?php _e( 'Categories: ', 'igoecreative' ); the_category(', '); ?></p>
