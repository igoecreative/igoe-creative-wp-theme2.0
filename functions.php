...
//Make additions for Bootstrap 4
...
// old below Pagination for paged posts with Next and Previous Links
// function igoe_pagination()
// {
//   global $wp_query;
//   $lots = 999999999;
...
add_action( 'login_enqueue_scripts', 'my_login_logo_one' );//adds custom logo to login page
add_action('widgets_init', 'my_remove_recent_comments_style'); // Remove inline Recent Comment Styles from wp_head()
add_action('init', 'igoe_pagination'); // Add Igoe Custom Pagination
// Remove Actions
...
// Add Filters
add_filter('tiny_mce_before_init', 'my_mce4_options');//changes color palette
